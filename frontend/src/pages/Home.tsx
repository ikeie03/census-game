...
const Home = () => {
  ...
  return (
    <div className="bg-darkblue">
      <Header />
      <div className="flex flex-col items-center min-h-screen  justify-center text-white text-center">
        ...
        <p className="text-lg mb-6 max-w-lg">
          A simple game of guessing which of two randomly generated queries in
          US census data has the higher value.
        </p>
        <p className="text-lg mb-6 max-w-lg">
          Inspired by the{" "}
